...
import YazhiniExampleYazhiniExampleExample from './yazhini/example/yazhini.example.example'
...
export default { 
  ...
  YazhiniExampleYazhiniExampleExample: load(YazhiniExampleYazhiniExampleExample, 'yazhini.example.example'),
